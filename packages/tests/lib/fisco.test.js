        ...
        examples: [
            {
                ...
                syncStatus: {
                    blockNumber: 28536,
                    genesisHash: 'e20e59e7dc025d979ffafafe8ef19f13d4060715b0f16f1050bdf7710e98ebd0',
                    isSyncing: false,
                    knownHighestNumber: 28536,
                    knownLatestHash: 'b7b64f7935f8343ad724eeedc97fc6460c375f68767eb9c9a406aa91f770d2cd',
                    latestHash: 'b7b64f7935f8343ad724eeedc97fc6460c375f68767eb9c9a406aa91f770d2cd',
                    nodeId: 'f3a1353a38f2022cc3a5b55e443e85eeb17e411dc4944aa74d1b9050880cf4c96b0014107703ede6bd551365def290936f47288a7e7cd90abde0ba5b3b4695e8',
                    peers: [
                        {
                            blockNumber: 28536,
                            genesisHash: 'e20e59e7dc025d979ffafafe8ef19f13d4060715b0f16f1050bdf7710e98ebd0',
                ...
                blockByTag: {
                    ...
                    stateRoot: '0x4c73e4c0827a23e5ad4a0c8d7c9be31a7e0db6f3cbd29857dfb7c86734aab723',
                    transactionsRoot: '0x615b947f3ed7ee1d92c242bf727a5ee76b0fe1537d9d39066c02b203dddeeb35',
                    receiptsRoot: '0x972d23e051bcd1a345b0d7872d30e09b798e7702e684e62dd0ca2404c55e930a',
                },
                blockHash: '0x3bc32897ea43e6667ffb0409990dbdea218525d754bcee354ce45c8b97a24df7',
                blockByAddress: {
                    extraData: [],
                    gasLimit: { _hex: '0x00', _isBigNumber: true },
                    gasUsed: { _hex: '0x00', _isBigNumber: true },
                ...
                blockWithTransactions: {
                    ...
                    transactions: [
                        {
                            hash: '0x2ed687722049a4fb94f1ce34714f5b20003bd2cf089530203754ca83458fb4a3',
                            blockHash: '0x3bc32897ea43e6667ffb0409990dbdea218525d754bcee354ce45c8b97a24df7',
                            blockNumber: 1,
                            transactionIndex: 0,
                            ...
                            to: null,
                            value: bnify(0x00),
                            data: '',
                ...
                providerSendTransactionResult: {
                    ...
                    extraData: '0x',
                    v: 28,
                    r: '0xe240d7e1f1cea773a54e32a81a6a8e4ae80c462a71c6aa0b089156566a2c0818',
                    s: '0x1b97c22b8a946d7e3f0ed36c9f04534d3ca0d23230a8872af10b75e7ffa639f3',
                    from: '0x8b4AB4667ad81AF60e914A33F3AEE35865825DF6',
                    hash: '0xb98d7bb7bfb21b4966b70a43d4e0d57ad04302bb1acaee39d0a7b3db501a0c7f',
                },
                getChainIdResult: 1,
                getGroupIdResult: 1,
                ...
                walletPubkey: '0x04646147a574bdaadb6157ff59260cd9ffd346dfdfd4dfbc3bb6495495f67b06385d05485072d4c5cc5e1c49e46557cef5811e0c255e48fb20c8d181cce4222bd2',
                abiTestData: {
                    function: {
                        functionFragmentSig: 'transfer(address,uint256)',
                        functionFragmentSighash: '0xa9059cbb',
                        decodeData: '0xa9059cbb0000000000000000000000008b4ab4667ad81af60e914a33f3aee35865825df60000000000000000000000000000000000000000000000056bc75e2d63100000',
                        encodeData: [
                            '0x8b4ab4667ad81af60e914a33f3aee35865825df6',
                    ...
                    event: {
                        ...
                        eventFragmentTopic: '0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef',
                        decodeData: '0x00000000000000000000000000000000000000000000000ad78ebc5ac6200000',
                        decodeTopic: [
                        ...
                        parseData: '0x00000000000000000000000000000000000000000000000ad78ebc5ac6200000',
                        getEventTopic: '0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef',
                    ...
                    result: {
                        ...
                        getEventTopic: '0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef',
                        encodeFunctionData: '0xa9059cbb0000000000000000000000008b4ab4667ad81af60e914a33f3aee35865825df60000000000000000000000000000000000000000000000056bc75e2d63100000',
                        decodeFunctionData: [
                            '0x8b4ab4667ad81af60e914a33f3aee35865825df6',
                            '100000000000000000000',
                        ],
...
function fiscoTest(config, example, abi) {
    ...
    test('provider.getSyncStatus', function () {
        provider.getSyncStatus().then(function (result) {
            ...
            result.peers.forEach(function (peer) {
    ...
    test('provider.getNodeIdList', function (done) {
        provider.getNodeIdList().then(function (result) {
    ...
    test('provider.getBlock by blockTag', function (done) {
        provider.getBlock(example.blockTag).then(function (block) {
            expect(block).toEqual(example.blockByTag);
            done();
        });
    });
    test('provider.getBlock by blockHash', function (done) {
        provider.getBlock(example.blockHash).then(function (block) {
            expect(block).toEqual(example.blockByAddress);
            done();
        });
    });
    test('provider.getBlockWithTransactions by blockTag', function (done) {
    ...
    test('provider.getBlockWithTransactions by blockHash', function (done) {
        provider.getBlock(example.blockHash).then(function (block) {
    ...
    test('provider.sendTransaction', function (done) {
        provider.sendTransaction(example.signTransactionResult).then(function (response) {
            ...
            expect(response.gasLimit).toEqual(example.providerSendTransactionResult.gasLimit);
            expect(response.to).toBe(example.providerSendTransactionResult.to);
            expect(response.value).toEqual(example.providerSendTransactionResult.value);
            expect(response.data).toBe(example.providerSendTransactionResult.data);
            expect(response.chainId).toBe(example.providerSendTransactionResult.chainId);
            expect(response.groupId).toBe(example.providerSendTransactionResult.groupId);
            expect(response.extraData).toBe(example.providerSendTransactionResult.extraData);
...
function matchTransaction(block, example) {
    ...
    block.transactions.forEach(function (transaction, index) {
        if (typeof transaction === 'object') {
            ...
            expect(transaction.blockNumber).toBe(example.transactions[index].blockNumber);
            ...
            expect(transaction.gasPrice).toEqual(example.transactions[index].gasPrice);
            expect(transaction.gasLimit).toEqual(example.transactions[index].gasLimit);
